...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['username','password', 'password_hash','password_reset_token','verification_token','email','auth_key','access_token'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'password' => 'Body Question',
            'password_hash' => 'Tag',
            'password_reset_token' => 'Created At',
            'verification_token' => 'Updated At',
            'email' => 'Created By',
            'auth_key' => 'Created At',
